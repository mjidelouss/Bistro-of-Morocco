        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg bg-transparent py-4 px-4 d-flex justify-content-between">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0 text-black"></h2>
                </div>
                <div class="d-flex">
                <div class="">
            ...
            <div class="container-fluid px-4">
                <center>
                    <div class="card mb-4">
                        <img src="/img/{{ $item->image }}" height="470px" width="90px" class="card-img-top" alt="">
                        <div class="card-body">
                          <h3 class="card-title fw-bold"><span style="color: hsl(24, 93%, 54%)">{{$item->name }}</h3>
                            <h5 class="card-text fw-bold"><span style="color: hsl(60, 3%, 7%)">{{$item->description }}</h5>
                            <h5 class="card-text fw-bolder"><span style="color: hsl(142, 100%, 25%)">{{$item->price }} DH</h5>
                        </div>
                      </div>
                </center>
                </div>
